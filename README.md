...
| `onFocus`                   | function            |                  | A function that is called when the node receives focus. Passed one argument, an [LRUDEvent](#lrudevent).                                          |
| `onBlur`                    | function            |                  | A function that is called when the node loses focus. Passed one argument, an [LRUDEvent](#lrudevent).                                             |
...
| `onSelect`                  | function            |                  | A function that is called when the user pressed the select button. Passed one argument, an [LRUDEvent](#lrudevent).                               |
